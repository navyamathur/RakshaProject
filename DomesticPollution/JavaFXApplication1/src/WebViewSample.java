 ...
 int i=0;
        ...
        try
    {
        //System.out.println("inside try");
            ...
            cn=DriverManager.getConnection(url);
             sql="Select time From URL2 where url='https://www.youtube.com'";
    ...
    Voice voice;
        ...
        voice=vm.getVoice(VOICENAME1);
         voice.allocate();
         voice.speak("you have used youtube for");
         int aa=Main1.main(null);
         String aaa=aa+"";
         voice.speak(aaa+"hours.Twinkle this is injurious to your health.");
      //   voice.speak("hours");
